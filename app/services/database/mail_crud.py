...
class MailCRUD:
    ...
    @staticmethod
    def get_mail_by_id(session: Session, mail_id: int) -> Optional[Mail]:
        """IDでメールを取得する.
    ...
    @staticmethod
    def get_mail_by_message_id(session: Session, message_id: str) -> Optional[Mail]:
        """メッセージIDでメールを取得する.
    ...
    @staticmethod
    def update_mail(session: Session, mail_id: int, mail_data: MailUpdate) -> Optional[Mail]:
        """メールを更新する.
    ...
    @staticmethod
    def mark_as_read(session: Session, mail_id: int) -> Optional[Mail]:
        """メールを既読にする.
    ...
    @staticmethod
    def mark_as_unread(session: Session, mail_id: int) -> Optional[Mail]:
        """メールを未読にする.
    ...
    @staticmethod
    def move_to_folder(session: Session, mail_id: int, folder: str) -> Optional[Mail]:
        """メールを指定フォルダに移動する.
